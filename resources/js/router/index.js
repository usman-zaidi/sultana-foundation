    ...
    children: [
      {
...

        {
            ...
            children: [
                ...
                {
                    path: '/donors/add-serology',
                    name: 'AddSerology',
                    component: () => import('../views/donors/add-serology.vue'),
                },
            ],
        },
...

        {
            ...
            redirect: '/patient/add-patient',
            children: [
                {
                    path: '/patient/add-patient',
                    name: 'AddPatient',
                    component: () => import('../views/patient/add-patient.vue'),
                },
            ],
        },

        {
            ...
            redirect: '/blood/add-blood-screening',
            children: [
                {
                    path: '/blood/add-blood-screening',
                    name: 'AddScreening',
                    component: () => import('../views/blood/blood-screening.vue'),
                },
            ],
        },
...
const router = createRouter({
  history: createWebHashHistory('dark'),
  routes,
  scrollBehavior() {
