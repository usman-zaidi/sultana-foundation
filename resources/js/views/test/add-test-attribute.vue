...
export default {
    ...
    data: () => ({name: "", allAttributes: []}),
    computed: {
        sortedList: function () {
            return this.allAttributes.slice().sort(function (a, b) {
    ...
    methods: {
        onSubmit() {
            this.allAttributes.push({name: this.name});
            this.clearForm();
        },
        clearForm() {
            this.name = "";
        ...
        removeElement: function (index) {
            this.allAttributes.splice(index - 1, 1);
        }
    },
}
</script>
